    ...
    return (
        <Suspense fallback={<LoadingScreen />}>
            <div className='thankYou__container'>
                ...
                <p className='thankYou__paragraph thankYou__bottom'>You can also reach us by emailing contact@websiteartificers.com or by checking us out on
                <a className='thankYou__link' href='https://www.linkedin.com/company/website-artificers' target="_blank" rel="noopener noreferrer">LinkedIn</a> and
                <a className='thankYou__link' href='https://www.facebook.com/websiteartificers' target="_blank" rel="noopener noreferrer">Facebook</a>. For the latest news and guides,
                <a className='thankYou__link' href='/blog'>check out our blog</a>!</p>
