...
const YOUTUBE_API_KEY: undefined = process.env.YOUTUBE_API_KEY; // Replace with your actual API key
const CHANNEL_ID: undefined = process.env.CHANNEL_ID; // Replace with your channel ID
