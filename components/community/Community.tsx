    ...
    return (
        <div className="community__container">
            ...
            <div className='community__subcontainer'>
                <a className='community__subcontainer--link' href='/contact/affiliates'>
                ...
                <a className='community__subcontainer--link' href='/blog'>
                ...
                <a className='community__subcontainer--link' href='/platform'>
            ...
            <div className='community__subcontainer'>
                <a className='community__subcontainer--link' href='/newsletter'>
                ...
                <a className='community__subcontainer--link' href='/pricing'>
                    ...
                    <button className='community__subcontainer--button button__tertiary'>See what our services offer</button>
                </a>
            </div>
        </div>
    )
